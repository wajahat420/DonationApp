...
export default class addBio extends Component {
      ...
      render() {
            ...
            let showInserBio = <View style={{marginTop:20}}>
            ...
            if(this.state.save.length !== 0 && this.state.insertBio === false){
                  showInserBio =  <View style={{margin:20}}>
                                    <Text style={{textAlign:"center",marginVertical:15,fontSize:20}}>{this.state.save}</Text>
